function [x,y] = fGetPts(varargin)
%GETPTS Select points with mouse (modified, T. Kuestner)
...
switch key
    ...
    case { char(27) } % esc key deletes all set points, cancels actions
        % remove all points
        set([GETPTS_H1 GETPTS_H2], ...
            'XData', [], ...
            'YData', []);
