...
%   'AnatomicalOrientation'     =   RAI (x axis is RUNNING FROM left to
%                                       right, the y axis is running from Posterior to Anterior, the z axis is running from Superior to Inferior)
