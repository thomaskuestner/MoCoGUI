...
% read all DICOM files from folder
%
% input:
% sFolder           DICOM folder
% 
% output:
% dImg              DICOM image
% SInfo             DICOM meta/header information
% SCoord            image coordination system

% -------------------------------------------------------------------------
% (c) 2013-2015: Christian Wuerslin, Thomas Kuestner
% -------------------------------------------------------------------------
